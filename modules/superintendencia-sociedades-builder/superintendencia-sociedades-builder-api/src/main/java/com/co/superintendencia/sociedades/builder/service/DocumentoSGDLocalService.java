...
/**
 * Provides the local service interface for DocumentoSGD. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DocumentoSGDLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DocumentoSGDLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.co.superintendencia.sociedades.builder.service.impl.DocumentoSGDLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the documento sgd local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DocumentoSGDLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DocumentoSGD addDocumentoSGD(DocumentoSGD documentoSGD);
	...
	public DocumentoSGD createDocumentoSGD(long documentoId);
	...
	public DocumentoSGD deleteDocumentoSGD(DocumentoSGD documentoSGD);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DocumentoSGD deleteDocumentoSGD(long documentoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DocumentoSGD getDocumentoSGD(long documentoId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DocumentoSGD> getDocumentoSGDs(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DocumentoSGD updateDocumentoSGD(DocumentoSGD documentoSGD);
