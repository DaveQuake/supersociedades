...
public interface DocumentoSGDLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>gov.co.supersociedades.sgd.sb.service.impl.DocumentoSGDLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the documento sgd local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DocumentoSGDLocalServiceUtil} if injection and service tracking are not available.
	 */
