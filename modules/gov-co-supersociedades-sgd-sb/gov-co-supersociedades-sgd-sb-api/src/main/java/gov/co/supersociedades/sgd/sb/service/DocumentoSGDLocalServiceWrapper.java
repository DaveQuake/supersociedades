...
public class DocumentoSGDLocalServiceWrapper
	 ...
	 */
	@Override
	public gov.co.supersociedades.sgd.sb.model.DocumentoSGD addDocumentoSGD(
	 ...
	 */
	@Override
	public gov.co.supersociedades.sgd.sb.model.DocumentoSGD createDocumentoSGD(
		long documentoId) {
	 ...
	 */
	@Override
	public gov.co.supersociedades.sgd.sb.model.DocumentoSGD deleteDocumentoSGD(
		gov.co.supersociedades.sgd.sb.model.DocumentoSGD documentoSGD) {
	...
	@Override
	public gov.co.supersociedades.sgd.sb.model.DocumentoSGD fetchDocumentoSGD(
		long documentoId) {
	...
	@Override
	public java.util.List<gov.co.supersociedades.sgd.sb.model.DocumentoSGD>
		findByNombre(String nombre) {

		return _documentoSGDLocalService.findByNombre(nombre);
	}
	...
	@Override
	public java.util.List<gov.co.supersociedades.sgd.sb.model.DocumentoSGD>
		findByUrlPaginaAndDate(String urlPagina, java.util.Date fechaActual) {
	 ...
	 */
	@Override
	public gov.co.supersociedades.sgd.sb.model.DocumentoSGD getDocumentoSGD(
			long documentoId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public gov.co.supersociedades.sgd.sb.model.DocumentoSGD updateDocumentoSGD(
		gov.co.supersociedades.sgd.sb.model.DocumentoSGD documentoSGD) {
